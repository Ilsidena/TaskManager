...
public class WeeklyTasks implements TaskList {
    ...
    public LinkedList<Task> getDateTasks (GregorianCalendar date) {
        ...
        for (Task itr : list[date.get (Calendar.DAY_OF_WEEK) - 1]) {
    ...
    public void add (Task task) {
        this.list[task.getDate ().get (Calendar.DAY_OF_WEEK) - 1].add (task);
        ++size;
    }
